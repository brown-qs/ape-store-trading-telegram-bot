...
export interface commandTask {
  ...
  target: string,
  price: number | string,
  type: number, //type==1 Buy a limited price，type==2 Sell ​​-limited sale
  amount?: number, //Purchase quantity
  sellPercent?: number, //Selling ratio
  gasFee: number,
  swapFee: number,
  privateKey: string
}
...
export interface msgPushCallBack {
  ...
  symbol: string,//Token
  totalSupply: string, //Total currency
  owner: string, //Contract owner
  firstPrice: string, //Initial price
  dexName: string, //Onlinedex
  scanUrl: string, //scanLink
  dexUrl: string, //scanLink
...
export interface watchLog {
  id?: number,
  chain_id: number,
  address: string, //Monitoring address
  name: string, //Surveying address name
  in_target: string, //Buy currency address
  ...
  in_version?: string,
  in_symbol?: string,
  out_target: string, //Output currency address
  ...
  out_version?: string,
  out_symbol?: string,
  telegram_id: number, //telegraphid
  telegram_name: string, //Telegraph name
  hash: string, //tradehex
  price: string, //Average transaction price
  amount_in: string, //How much
  amount_out: string,//How much income
  cost: number, //cost price pay + gas
  type: number, //type 1Buy 2Sell
  left_amount?: string, //Remaining position
  swap_fee: number, //Sale and sale sliding point
