...
//Treat whether to destroy contract ownership
...
//Handle pool pools (v2Pool | v3Pool)
...
//Process basic information of the contract
...
//Treatment of currency price of liquidity
...
//Processing creation contractevent
...
export const queryContract = async (address: string, chainID: number) => {
  //Get the basic information of the contract
  let contracts: any = await batchGetBaseData([address], chainID)
  if (contracts[0]) {
    //Sort the basic information of the contract
    contracts = await formatBaseData(contracts, chainID)
...
//deal withswapeventAll addresses
...
//Get the contract for all holders of the contract
